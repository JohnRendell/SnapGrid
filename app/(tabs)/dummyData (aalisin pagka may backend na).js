export const DummyData_Home_Page = [
        { id: 1, img: require("./Dummy_Images_(Aalisin pagka may backend na)/MrKrabs.webp"), userID: 123 },
        { id: 2, img: require("./Dummy_Images_(Aalisin pagka may backend na)/Patrick.webp"), userID: 213 },
...
export const DummyData_User_Profile = [
        { profile: require("./Dummy_Images_(Aalisin pagka may backend na)/MrKrabs.webp"), userID: 123, username: "dummy1" },
        { profile: require("./Dummy_Images_(Aalisin pagka may backend na)/Patrick.webp"), userID: 213, username: "dummy2" },
